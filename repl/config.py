...
def configure(repl):
    ...
    """
    # History file
    repl.history_filename = os.path.expanduser("~/.local/share/ptpython/history")
    ...
    @repl.add_key_binding("backspace")
    @repl.add_key_binding("c-h")  # common when Backspace arrives as ^H over BT/VM paths
    def _(event):
